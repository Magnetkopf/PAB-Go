...
async function submit() {
  ...
  try {
    ...
    nickname.value = ""; content.value = ""; image.value = null; message.value = t("ask.submitted");
  } catch (error) { message.value = error instanceof Error ? error.message : t("ask.failed"); }
}
</script>
