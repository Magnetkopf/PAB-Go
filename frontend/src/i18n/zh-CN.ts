export default {
  ...
  admin: { eyebrow: "管理后台", title: "管理你的提问箱", loginDescription: "登录后查看收到的问题，并管理公开展示内容。", username: "账号", password: "密码", login: "登录", loginFailed: "登录失败", menuTitle: "你想管理什么？", menuDescription: "选择一个功能开始。", questions: "问题列表", questionsDescription: "查看、回答、发布或删除收到的问题", settings: "自定义设置", settingsDescription: "个性化网站内容与显示选项", dashboard: "仪表盘", allQuestions: "全部问题", pendingQuestions: "待回答", sessions: "登录会话", sessionsDescription: "撤销不再使用的设备登录；撤销当前会话后将立即退出登录。", session: "已登录设备", currentSession: "当前设备", sessionExpires: "有效至 {time}", revoke: "撤销", noSessions: "没有有效会话。", sessionRevokeFailed: "无法撤销会话" },
  ...
  settings: { eyebrow: "站点外观", title: "自定义设置", description: "逐项调整公开页面的外观和署名。", basics: "基础内容", theme: "主题", security: "安全性", sessions: "登录会话", sessionsDescription: "管理已登录设备", session: "已登录设备", currentSession: "当前设备", sessionCreated: "创建于 {time}", sessionExpires: "有效至 {time}", revoke: "撤销", noSessions: "没有有效会话。", loadingSessions: "正在读取会话…", sessionsLoadFailed: "无法读取会话", sessionRevokeFailed: "无法撤销会话", siteName: "站点名称", copyrightName: "版权名称", maxUploadKB: "最大图片上传（KB）", primaryColor: "全局主题色", cardOpacity: "卡片透明度：{value}%", save: "保存设置", saved: "设置已保存。", loadFailed: "无法读取设置", saveFailed: "保存失败" },
